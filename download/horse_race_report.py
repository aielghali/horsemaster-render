...
story.append(Paragraph('تقرير ترشيحات سباقات الخيل', subtitle_style))
story.append(Spacer(1, 20))
story.append(Paragraph('مضمار ميدان - دبي', subtitle_style))
story.append(Paragraph('13 فبراير 2026', subtitle_style))
story.append(Spacer(1, 30))
story.append(Paragraph('مهرجان دبي العالمي للسباقات - الأسبوع السابع', body_style))
story.append(Spacer(1, 15))

# Info box
info_data = [
    [Paragraph('<b>المعلومات</b>', header_style), Paragraph('<b>التفاصيل</b>', header_style)],
    [Paragraph('المضمار', cell_style), Paragraph('Meydan Racecourse - Dubai', cell_style)],
    [Paragraph('التاريخ', cell_style), Paragraph('13 فبراير 2026', cell_style)],
    [Paragraph('عدد السباقات', cell_style), Paragraph('8 سباقات', cell_style)],
    [Paragraph('الأسطح', cell_style), Paragraph('Dirt & Turf', cell_style)],
]
...
story.append(Paragraph('<b>السباق المطلوب (2:05)</b>', heading_style))
story.append(Paragraph('Longines Master Collection Year Of The Horse (Maiden) - Dirt', body_style))
story.append(Spacer(1, 10))

story.append(Paragraph('<b>الترشيحات الرئيسية</b>', subheading_style))
...
# Analysis
story.append(Paragraph('<b>تحليل المرشحين</b>', subheading_style))
story.append(Paragraph(
    '<b>Ah Tahan (AE) - Rating 96:</b> الخيل الأقوى تصنيفاً في السباق بفارق كبير عن المنافسين. '
...
story.append(Paragraph(
    '<b>Baeed (AE) - Rating 85:</b> ثاني أفضل تصنيف في السباق. لديه خبرة على مسارات ميدان، '
...
story.append(Paragraph('<b>🌟 NAP of the Day: Ah Tahan 🌟</b>', nap_style))
story.append(Paragraph('أفضل فرصة للفوز اليوم - الخيار الأكثر أماناً للمراهنة', body_style))
story.append(Spacer(1, 25))

# All Races Summary
story.append(Paragraph('<b>ملخص ترشيحات جميع السباقات</b>', heading_style))
story.append(Spacer(1, 10))

all_races_data = [
    [Paragraph('<b>الوقت</b>', header_style), 
...
# Key Jockeys
story.append(Paragraph('<b>الفرسان البارزون</b>', heading_style))
story.append(Spacer(1, 10))

jockeys_data = [
    [Paragraph('<b>الفارس</b>', header_style), 
     Paragraph('<b>الخيل</b>', header_style), 
     Paragraph('<b>السباق</b>', header_style),
     Paragraph('<b>ملاحظات</b>', header_style)],
    [Paragraph('Silvestre De Sousa', cell_style), 
     Paragraph('Saafeer', cell_style), 
     Paragraph('14:40', cell_style),
     Paragraph('بطل سابق في دبي', cell_style)],
    [Paragraph('Bernardo Pinheiro', cell_style), 
     Paragraph('Ah Tahan', cell_style), 
     Paragraph('13:30', cell_style),
     Paragraph('خبرة في الخيل العربية', cell_style)],
    [Paragraph('T P O\'Shea', cell_style), 
     Paragraph('Elusive Trevor', cell_style), 
     Paragraph('16:25', cell_style),
     Paragraph('فارس محترف', cell_style)],
    [Paragraph('R Mullen', cell_style), 
     Paragraph('No Escape', cell_style), 
     Paragraph('17:35', cell_style),
     Paragraph('مدرب B Seemar', cell_style)],
]
...
# Important Notes
story.append(Paragraph('<b>ملاحظات مهمة</b>', heading_style))
story.append(Spacer(1, 8))
notes = [
    'هذه الترشيحات مبنية على تحليل نموذج Elghali Ai للبيانات المتاحة.',
    'التصنيف (Rating) يعتبر مؤشراً رئيسياً على قدرة الخيل التنافسية.',
    'الخبرة السابقة على مضمار ميدان تعتبر عاملاً مهماً.',
    'حالة الطقس والسطح قد تؤثر على النتائج.',
...
story.append(Spacer(1, 20))
story.append(Paragraph('<b>المصدر:</b> Racing Post & Emirates Racing Authority', body_style))
